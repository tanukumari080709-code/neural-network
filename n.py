...
st.set_page_config(page_title="Neural Pattern Lab", layout="wide")

with open("neural-pattern-lab.html", "r", encoding="utf-8") as f:
    html_content = f.read()

components.html(html_content, height=6000, scrolling=True)<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
